...
INPUT_FILE = "hsbc_q1_ragas_rows.jsonl"  # change as needed

# Generate timestamped output filenames
STAMP = datetime.now().strftime("%Y%m%d_%H%M%S")
OUTPUT_CSV = f"hsbc_q1_ragas_results_{STAMP}.csv" # change as needed
OUTPUT_JSON = f"hsbc_q1_ragas_results_{STAMP}.json" # change as needed
