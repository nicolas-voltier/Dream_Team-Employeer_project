...
INPUT_FILE = "stress_test_ragas_input.jsonl"  # change as needed

# Generate timestamped output filenames
STAMP = datetime.now().strftime("%Y%m%d_%H%M%S")
OUTPUT_CSV = f"stress_test_ragas_results_{STAMP}.csv"
OUTPUT_JSON = f"stress_test_ragas_results_{STAMP}.json"
